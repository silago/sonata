					...
					<div class="serv-form">
						<div class="block">
							...
							<div class="s1 block">
								...
								<input type="text" placeholder="" value="{$userdata.data.order.street}" name="order_street" />	
							</div>
							...
							<div class="s1 block">
								<div class="bl-box">
											<div class="adr">
												<span>Дом </span>
												<input type="text" value="{$userdata.data.order.house}" name="order_house" placeholder="" class="c1" />	
											</div>

											<div class="adr">
												<span>Корпус</span>
												<input type="text" value="{$userdata.data.order.corp}" name="order_corp" placeholder="" class="c2" />	
											</div>	

											<div class="adr">
												<span>Квартира/офис</span>
												<input type="text" placeholder="" value="{$userdata.data.order.office}" name="order_office" class="c3" />	
											</div>
										</div>	
							</div>
