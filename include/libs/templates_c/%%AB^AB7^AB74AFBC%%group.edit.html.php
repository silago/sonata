<?php /* Smarty version 2.6.16, created on 2014-02-25 15:12:26
...
" method="post" enctype="multipart/form-data" onsubmit='disableSubmit("submitFormKey", "Пожалуйста, подождите..")'>
	<fieldset>
		<div class="row">
			...
			<div class="span3">
			<div class="control-group">
			<label class="control-label" for="status"><strong>Доп. параметры:</strong></label>			
				<div class="controls">
                    <select name="status" id="status">
                        <option value="">Ничего особенного </option>
                        <option value="hidden">Группа скрыта</option> 
                        <option value="main">Группа на главной</option> 
                    </select>
