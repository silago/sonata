<?php /* Smarty version 2.6.16, created on 2013-10-30 14:27:23
         compiled from ru/modules/catalog/admin/item.add.html */ ?>
<ul class="breadcrumb">
	...
	<li class="active"><a href="/admin/catalog/addItem.php">Добавление товара</a></li>
</ul>

<?php echo $this->_tpl_vars['error']; ?>


<form action="addItemGo.php?lang=<?php echo $this->_tpl_vars['curLang']; ?>
" method="post" enctype="multipart/form-data" onsubmit='disableSubmit("formSubmit");'>
  <input type="hidden" id="action" value="addItem">
  <fieldset>
  <div class="row">
	<div class="span6">
...
" maxlength="255" style="width: 80%;" tabindex="3"/>
	...
	<div class="span1">
			<div class="control-group">			
				<div class="controls">
					<label class="checkbox" for="new">Новинка<input name="new" id="new" type="checkbox" value="1" tabindex="4"/></label>
				</div>
			</div>
	</div>
	<div class="span2">
			<div class="control-group">			
				<div class="controls">
					<label class="checkbox" for="hit">Хит продаж<input name="hit" id="hit" type="checkbox" value="1" tabindex="5"/></label>
				</div>
			</div>
	</div>
  </div>
...
" maxlength="255" style="width: 80%;" tabindex="1" />
		...
		<div class="span6">
			...
			<label class="control-label" for="price">Цена:</label>
				<div class="controls">
					<input type="text" rel="tooltip" data-original-title='Значение цены должно иметь вид "0.00" или "0,00" или "0"' id="price" name="price" value="<?php echo $this->_tpl_vars['price']; ?>
	...
	<div class="row">
		<div class="span6">
			...
			<label class="control-label" for="uri"><strong>uri:</strong></label>
				<div class="controls">
					<input type="text" id="uri" name="uri" value="<?php echo $this->_tpl_vars['uri']; ?>
" maxlength="255" style="width: 80%;" tabindex="2" />
		...
		<div class="span6">
			...
			<label class="control-label" for="price_old">Старая цена:</label>
				<div class="controls">
					<input type="text" rel="tooltip" data-original-title='Значение цены должно иметь вид "0.00" или "0,00" или "0"' id="price_old" name="price_old" value="<?php echo $this->_tpl_vars['price_old']; ?>
" maxlength="255" style="width: 80%;" tabindex="7"/>
	...
	<div class="row">
		<div class="span6">
			<div class="control-group">
			<label class="control-label" for="uri"><strong>Бренды:</strong></label>
				<div class="controls">
					<?php echo $this->_tpl_vars['brands']; ?>
	...
	<div class="row">
		<div class="span12">
                ...
                <button type="submit" class="btn btn-primary pull-right" tabindex="13">Сохранить</button>
