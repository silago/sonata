...
<div class="boxCont">
				<div class=" orderLeft ">
					...
					<div class="contentSumm">
						<p>{$count} штук(-а)</p><p>{$total} руб.</p>
						<div class="clear"></div>
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="prods_content cart" style="margin-left:10px; color: #888;">
				...
				<tr>
					...
					<tr>
						...
						<td><input size="30" name="surname" type="text" value="{$surname}"></td>
					</tr>
					...
					<tr>
						...
						<td><input size="30" class="required" name="name" type="text" value="{$name}"></td>
					</tr>
					...
					<tr>
						...
						<td><input size="30" class="required" name="patronymic" type="text" value="{$patronymic}"></td>
					</tr>
					
					<tr>
						<td class="key" style="text-align:left;"><font color="#F20006">*</font> Email адрес:</td>
						<td><input size="30" class="required" name="email" type="text" value="{$email}"></td>
					</tr>
					{$form}
					<tr>
...
<table border="0" cellspacing="0" cellpadding="0" class="prods_content cart" style="margin-left:25px;margin-top:15px;width:705px; color: #888; display:none;">
					<tbody>
						...
						{foreach from=$basket item=item key=key}
						<tr style="vertical-align:top;" class="sectiontableentry2">
                            <td  style="text-align:center; border-right: 1px solid #E5E5E5; border-bottom:1px solid #E5E5E5;">								
                                <span class="cart-title"><a href="/{$item.uri}">{$item.name}</a></span>
                            </td>
                            <td style="text-align:center; border-right: 1px solid #E5E5E5; border-bottom:1px solid #E5E5E5;">
                                {$item.article}
                            </td>
                            <td  style="text-align:center;  border-right: 1px solid #E5E5E5; border-bottom:1px solid #E5E5E5;">{$item.price}</td>
                            <td  style="text-align:center;  border-right: 1px solid #E5E5E5; border-bottom:1px solid #E5E5E5;">{$item.quantity}</td>
                            <td colspan="1" align="center" style="border-right: 1px solid #E5E5E5; border-bottom:1px solid #E5E5E5;"><strong>{$item.total} р.</strong></td>
                        </tr>
						{/foreach}
		                <tr class="sectiontableentry2 bg-top">
			                ...
			                <td align="center" class="total"><strong>{$total} р.</strong></td>
		                </tr>						
                    </tbody>
                </table>
